...
type TuseIsIntersectingOptions = {
...
export function useIsIntersecting(ref: React.MutableRefObject<HTMLElement>, options: TuseIsIntersectingOptions = {}) {
  const [isIntersecting, setIntersecting] = React.useState(false)

  options = { ...options } as TuseIsIntersectingOptions
